...
public class BankApplication {
	...
	public BankApplication(String name, String add, String cno, String uname, String pwd, int dep, String type) {
		super();
		this.name = name;
		this.add = add;
		this.cno = cno;
	...
	public BankApplication(int amt) {
		this.amt = amt;
	}
	...
	public static void main1() {
		...
		if (choice == 1) {
			...
			BankApplication b1 = new BankApplication(name, add, cno, uname, pwd, dep,type);
			main1();

			BankApplication[] bankRecords = { b1 };
		}
